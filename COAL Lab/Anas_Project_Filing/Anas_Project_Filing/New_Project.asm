...
mov edi, OFFSET Level3Q + 92
rep movsb
mov Level3Q[184], 0

mov ecx, q3
mov esi, OFFSET buffer + 275
mov edi, OFFSET Level3Q + 275
rep movsb
mov Level3Q[276], 0

mov ecx, q4
mov esi, OFFSET buffer + 424
mov edi, OFFSET Level3Q + 424
rep movsb
mov Level3Q[425], 0

mov ecx, q5
mov esi, OFFSET buffer + 642
mov edi, OFFSET Level3Q + 642
rep movsb
mov Level3Q[643], 0

mov ecx, q6
mov esi, OFFSET buffer + 739
mov edi, OFFSET Level3Q + 739
rep movsb
mov Level3Q[740], 0

mov ecx, q7
mov esi, OFFSET buffer + 920
mov edi, OFFSET Level3Q + 920
rep movsb
mov Level3Q[921], 0

mov ecx, q8
mov esi, OFFSET buffer + 999
mov edi, OFFSET Level3Q + 999
rep movsb
mov Level3Q[1000], 0

mov ecx, q9
mov esi, OFFSET buffer + 1096
mov edi, OFFSET Level3Q + 1096
rep movsb
mov Level3Q[1097], 0

mov ecx, q10
mov esi, OFFSET buffer + 1213
mov edi, OFFSET Level3Q + 1213
rep movsb
mov Level3Q[1214], 0
